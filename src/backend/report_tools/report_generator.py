...
class ReportGenerator:
    ...
    SUBTITLES = {
        ...
        "Spatial Resolution": "This measurement gives an indication as to the ability of the scanner to image subtle anatomical features by assessing the in-plane resolution. There are no official tolerance intervals for this measurement and the suggestion is to follow this over time and be observant to any unexpected changes.",
    }
