...
# class ModalTaskRunnerLight(tk.Toplevel):

#     def __init__(self, master: tk.Tk, long_task: Callable, task_name: str):
#         super().__init__(master)
...
#         threading.Thread(target=self._run_task_wrapper)
#         master.wait_window()

#     def _create_widgets(self):
#         self.label = tk.Label(self, text=self.task_name)
#         self.progress_bar = ttk.Progressbar(
#             self, variable=self.progress_var, mode="indeterminate", maximum=100
#         )
