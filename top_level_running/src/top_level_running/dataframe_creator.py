...
class DataFrameCreator:
    ...
    def __init__(self, outer: "TaskLooperRSCH"):
        self.outer = outer
        self.df_width = len(self.outer.possible_keys["orientations"]) + 1
        self.df_components = {
            "title_rows": [
                pd.DataFrame(
            ...
            "orientations_row": pd.DataFrame(
                [np.nan] + self.outer.possible_keys["orientations"]
            ).T,
            "coil_rows": {
